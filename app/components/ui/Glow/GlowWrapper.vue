...
<template>
  <component
    ...
    :class="{ ['glow-container--hover']: hoverEffect }"
  >
    <div :style="glowStyle" class="glow-container__border"></div>
    <slot />
  </component>
</template>
...
.glow-container {
  ...
  &__border {
    ...
    opacity: 0.4;
    mask:
      linear-gradient(rgba($color-white, 1) 0 0) content-box,
      linear-gradient(rgba($color-white, 1) 0 0);
    mask-composite: xor;
